...
{/* TopAppBar */}
<nav className="bg-surface/60 backdrop-blur-2xl text-primary font-headline-md text-headline-md docked full-width top-0 sticky z-40 flex justify-between items-center px-margin-page py-unit h-16 w-full">
...
<a className="text-primary font-bold hover:text-primary transition-colors duration-300 scale-95 transition-transform duration-200" href="#">Intelligence Canvas</a>
<a className="text-on-surface-variant/60 hover:text-primary transition-colors duration-300 scale-95 transition-transform duration-200" href="#">Knowledge Constellation</a>
<a className="text-on-surface-variant/60 hover:text-primary transition-colors duration-300 scale-95 transition-transform duration-200" href="#">Source Hub</a>
</div>
...
<img alt="" className="w-full h-full object-cover mix-blend-multiply opacity-80" data-alt="A sophisticated digital landscape featuring floating translucent glass shards and glowing semantic nodes interconnected by thin golden threads. The lighting is ethereal and soft, reflecting a warm ivory and dusty lavender palette. The overall mood is serene and intellectually focused, mimicking high-end scandinavian architectural photography with a focus on depth and spatial clarity." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBwVFfYeHGjPBmsBTm7pZRcMlZU0kBuxVPCs1NtB6EDGSDNnZ552Xk_FJ_VV8V2SwnhtQ6u6coPcNGX3lIpCRUhLpIl96LRL1TH9UsSHi7qjXiHECSlNTCV-zUKJH0jzz85AMqcdem4aYy7J6D3R8w5qwU1hPiM7k2vLrcOy7rFVvf7z1l8NyigFgVbJTxNqR_nlBX7tkwCRy_BoEUCm7aDwRTIgWAHvZKxG5llPuwjwwbiLKfel_Gq_m750Xra11LuAsLrvCnYQCk"/>
...
<button className="bg-primary text-on-primary px-8 py-4 rounded-full font-label-caps text-label-caps hover:bg-on-surface transition-all scale-100 hover:scale-105 active:scale-95 shadow-lg shadow-primary/10">
                    BEGIN SYNTHESIS
                </button>
<button className="bg-surface-container-highest/50 border border-outline-variant/30 px-8 py-4 rounded-full font-label-caps text-label-caps hover:bg-surface-variant transition-all">
                    EXPLORE PHILOSOPHY
                </button>
</div>
</section>
...
{/* Ingestion UI Mockup */}
<div className="w-40 h-56 bg-surface p-4 border border-outline-variant/40 rounded-xl shadow-sm translate-y-8 group-hover:translate-y-4 transition-transform duration-500">
...
<div className="w-40 h-56 bg-surface p-4 border border-outline-variant/40 rounded-xl shadow-md translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
...
<div className="w-40 h-56 bg-surface p-4 border border-outline-variant/40 rounded-xl shadow-lg translate-y-12 group-hover:translate-y-8 transition-transform duration-500">
...
{/* Synthesis Preview */}
<div className="col-span-12 md:col-span-5 h-[500px] p-12 bg-secondary-container/10 border border-secondary-container/20 rounded-3xl relative flex flex-col justify-between">
<div>
...
<img alt="" className="w-full h-[600px] object-cover opacity-60 mix-blend-luminosity" data-alt="A cinematic, wide-angle shot of a minimalist workspace featuring a solid light oak desk, a singular high-resolution display showing complex intelligence graphs, and large floor-to-ceiling windows overlooking a misty Scandinavian forest at twilight. The lighting is moody yet warm, emphasizing natural textures and soft shadows. The atmosphere is one of profound focus and premium intellectual luxury." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDLqVwNQWXJf9dml5ojzeBn3IRKdGWBtx4R08-ahfGn0dL2nvgGAVTqqXiIP2wAMFX88_M1Cz648OpzS_LUs8JFRGmxWpD3yyAFGERr3GraE2xCut_glbL6U4IJWtzcHyVLwkEzS4-VpIWTtTYG299cccsmrsT2rtAfyBK_5rRbg7G6VwlY5k0HeQYBu-sw-Y9FrE3pIyhZzDns3gYvinO_-vVQ106gOP-NpOTiStOXTCujWsAhLBzYPzWi3prE_RexkSh0XGvRX-g"/>
...
<button className="px-8 py-4 bg-primary text-on-primary rounded-full font-label-caps text-label-caps hover:bg-on-surface transition-all">RESERVE ACCESS</button>
</div>
</div>
</div>
</section>
...
<a className="font-body-md text-body-md text-on-surface-variant hover:text-primary transition-colors opacity-80 hover:opacity-100" href="#">Philosophy</a>
<a className="font-body-md text-body-md text-on-surface-variant hover:text-primary transition-colors opacity-80 hover:opacity-100" href="#">Security</a>
<a className="font-body-md text-body-md text-on-surface-variant hover:text-primary transition-colors opacity-80 hover:opacity-100" href="#">API</a>
